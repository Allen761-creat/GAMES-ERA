...
const Footer = () => {
  return (
    <div className='dark:bg-black'><br/><br/><br/>
      <footer className="bg-gray-900 ">
  <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
    <h1 className='text-[orange] text-center font-bold text-[30px] '>𝓖𝓐𝓜𝓔𝓢 𝓔𝓡𝓐</h1>  
        <div className="flex justify-center text-teal-300 sm:justify-start">
        </div>
        <p className="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left">
        Discover Fresh Deals and Electrifying Offers, Only at Fresh Volt.Revitalize Your Shopping with Fresh Volt  Where Every Purchase Sparks Joy.
        </p>
